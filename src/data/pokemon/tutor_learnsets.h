...
static const u32 sTutorLearnsets[] =
{
    ...
    [SPECIES_FLAREON]          = (TUTOR(MOVE_SWORDS_DANCE)
                                | TUTOR(MOVE_BODY_SLAM)
                                | TUTOR(MOVE_DOUBLE_EDGE)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_SUBSTITUTE)
...
[SPECIES_CHIMCHAR]      = (TUTOR(MOVE_COUNTER)
    ...
    [SPECIES_MEGA_CHIMECHO]         = (TUTOR(MOVE_DOUBLE_EDGE)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_DREAM_EATER)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_ROLLOUT)
    ...
    [SPECIES_TOXLIME_G]              = (TUTOR(MOVE_ROCK_SLIDE)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_SNORE)
                                | TUTOR(MOVE_ICY_WIND)
                                | TUTOR(MOVE_MUD_SLAP)
    ...
    [SPECIES_TOXLIME_W]              = (TUTOR(MOVE_ROCK_SLIDE)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_SNORE)
                                | TUTOR(MOVE_ICY_WIND)
                                | TUTOR(MOVE_MUD_SLAP)
    ...
    [SPECIES_TOXLIME_E]              = (TUTOR(MOVE_ROCK_SLIDE)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_SNORE)
                                | TUTOR(MOVE_ICY_WIND)
                                | TUTOR(MOVE_MUD_SLAP)
    ...
    [SPECIES_STRANCLOUD]              = (TUTOR(MOVE_MEGA_PUNCH)
                                | TUTOR(MOVE_DOUBLE_EDGE)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_PSYCH_UP)
                                | TUTOR(MOVE_SNORE)
    ...
    [SPECIES_MEGA_STRANCLOUD]              = (TUTOR(MOVE_MEGA_PUNCH)
                                | TUTOR(MOVE_DOUBLE_EDGE)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_PSYCH_UP)
                                | TUTOR(MOVE_SNORE)
