...
static const u8 sSpeciesToBackAnimSet[] =
{
	...
	[SPECIES_DURALUDON] = BACK_ANIM_FLASH_YELLOW_WITH_SHAKE,
	...
	[SPECIES_MEGA_CHIMECHO] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
	[SPECIES_TOXLIME_G] = BACK_ANIM_VERTICAL_SHAKE,
	[SPECIES_TOXLIME_W] = BACK_ANIM_VERTICAL_SHAKE,
	[SPECIES_TOXLIME_E] = BACK_ANIM_VERTICAL_SHAKE,
    [SPECIES_STRANCLOUD] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_MEGA_STRANCLOUD] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
