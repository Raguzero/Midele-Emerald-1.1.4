...
extern const u32 gMonFrontPic_MegaChimecho[];
extern const u32 gMonPalette_MegaChimecho[];
extern const u32 gMonBackPic_MegaChimecho[];
extern const u32 gMonShinyPalette_MegaChimecho[];
extern const u8 gMonIcon_MegaChimecho[];
extern const u8 gMonFootprint_MegaChimecho[];
extern const u32 gMonFrontPic_Toxlime_G[];
extern const u32 gMonPalette_Toxlime_G[];
extern const u32 gMonBackPic_Toxlime_G[];
extern const u32 gMonShinyPalette_Toxlime_G[];
extern const u8 gMonIcon_Toxlime_G[];
extern const u32 gMonFrontPic_Toxlime_W[];
extern const u32 gMonPalette_Toxlime_W[];
extern const u32 gMonBackPic_Toxlime_W[];
extern const u32 gMonShinyPalette_Toxlime_W[];
extern const u8 gMonIcon_Toxlime_W[];
extern const u32 gMonFrontPic_Toxlime_E[];
extern const u32 gMonPalette_Toxlime_E[];
extern const u32 gMonBackPic_Toxlime_E[];
extern const u32 gMonShinyPalette_Toxlime_E[];
extern const u8 gMonIcon_Toxlime_E[];
extern const u32 gMonFrontPic_Strancloud[];
extern const u32 gMonPalette_Strancloud[];
extern const u32 gMonBackPic_Strancloud[];
extern const u32 gMonShinyPalette_Strancloud[];
extern const u8 gMonIcon_Strancloud[];
extern const u32 gMonFrontPic_MegaStrancloud[];
extern const u32 gMonPalette_MegaStrancloud[];
extern const u32 gMonBackPic_MegaStrancloud[];
extern const u32 gMonShinyPalette_MegaStrancloud[];
extern const u8 gMonIcon_MegaStrancloud[];
...
extern const u32 gItemIcon_CloudPowder[];
extern const u32 gItemIconPalette_CloudPowder[];
// Contest hold items
